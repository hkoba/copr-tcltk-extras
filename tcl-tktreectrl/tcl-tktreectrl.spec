...
Source0:	https://www.tcl3d.org/bawt/download/InputLibs/%{nickname}-%{version}.7z
Patch0:		tcl-tktreectrl-tcl-size.patch
Patch1:		tcl-tktreectrl-misc.patch
